const projects = [
  {
    ...
    desc: "Using docker's deploy process with an interface via the browser.",
    ...
    techs: ["NodeJS", "Linux", "Tailwind", "Docker", "React", "ExpressJS"],
  },
  {
    name: "Chat Application",
    url: "https://github.com/ensarsnr/chat-app-frontend",
    desc: "I made a real time chat application. I used Backend and Database.",
    ...
    techs: ["NextJS", "Tailwind", "MongoDB", "NodeJS", "ExpressJS"],
  },
  {
    name: "Beatiful React Hooks",
    url: "https://github.com/ensarsnr/beautiful-react-hooks",
    desc: "I provided Turkish support to a react special hook library that I liked.",
